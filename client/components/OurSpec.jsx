...
const OurSpecs = () => {
    ...
    return (
        <div className='px-6 my-20 max-w-6xl mx-auto'>
            <Title visibleButton={false} title='Nos Avantages' description="Nous offrons un service de qualité supérieure et un confort optimal pour garantir que votre expérience d'achat soit fluide, sécurisée et totalement sans tracas." />
