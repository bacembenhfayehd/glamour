...
import x from './blue.png'
import y from './yellow.png'
import z from './pexels-ox-street-3848035-6050910-removebg-preview.png'
...
export const categories = ["Sport", "Casual", "Chic", "Outdoor", "Streetwear", "Mode","Minimaliste"];
...
export const ourSpecsData = [
    { title: "Livraison Gratuite", description: "Profitez d'une livraison rapide et gratuite sur chaque commande, sans condition, directement à votre porte.", icon: SendIcon, accent: '#05DF72' },
    { title: "Retour Facile sous 7 Jours", description: "Vous avez changé d'avis ? Aucun problème. Retournez tout article dans les 7 jours.", icon: ClockFadingIcon, accent: '#FF8904' },
    { title: "Service Client 24/7", description: "Nous sommes là pour vous. Bénéficiez d'une assistance experte avec notre service client disponible 24h/24.", icon: HeadsetIcon, accent: '#A684FF' }
]
